...
class ProductController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        ProductCat::where('product_id', $id)->delete();

        //re-insert

        $this->updateProductCat($request, $id);
    ...
    public function store(Request $request)
    {
        ...
        $this->updateProductCat($request, $data->id);
    ...
    protected function updateProductCat(Request $request, $id)
    {
        if($request->category) {
